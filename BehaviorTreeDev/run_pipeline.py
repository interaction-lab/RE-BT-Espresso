...
def parse_args():
    ...
    return json_file_path, should_recolor, run_original_bt_espresso, run_with_gfactor


def run_pipeline(json_file_path, should_recolor, fmt_file_path, run_original_bt_espresso, run_with_gfactor):
    ...
    bt_tree_filepath_list = behaviortree_3.run_behaviortree(
        json_file_path, fmt_file_path, run_original_bt_espresso, run_with_gfactor)
...
def main():
    ...
    """
    json_file_path, should_recolor, run_original_bt_espresso, run_with_gfactor = parse_args()
    global expr_name
    expr_name = json_file_path
    run_pipeline(json_file_path, should_recolor,
                 DEFAULT_OUTPUT_PATH, run_original_bt_espresso, run_with_gfactor)
